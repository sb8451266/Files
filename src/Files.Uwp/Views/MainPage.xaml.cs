...
namespace Files.Uwp.Views
{
    ...
    public class TabbedBrush : XamlCompositionBrushBase
    {
        public TabbedBrush(bool checkForCompositionSupport = true)
        {
        ...
        private void UpdateBrush()
        {
            ...
            Color tintColor = currentTheme == ElementTheme.Light ? Color.FromArgb(255, 10, 10, 10) : Color.FromArgb(255, 232, 232, 232);
            float tintOpacity = currentTheme == ElementTheme.Light ? 0f : 0.5f;
